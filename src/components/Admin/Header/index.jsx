...
const AdminHeader = () => {
    ...
    const toggleSidebar = () => { setIsOpen(!isOpen), console.log("ha ma " + isOpen) };
    ...
    return (
        <>
            <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div class="flex items-center sm:justify-start justify-between">
                        <button onClick={toggleSidebar} type="button" className="inline-flex sm:hidden items-center p-2 text-sm text-gray-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">

                            <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                            </svg>
                        </button>
                        <div class="flex w-full justify-center ms-2 md:me-24">
                            <Image
                                src={logo}
                                alt="Logo"
                                width={219}
            ...
            <div className={`fixed top-0 left-0 z-40  w-64 h-screen pt-20 ${!isOpen ? "-translate-x-full" : "translate-x-0 "} transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"`}>
                ...
                <div className="h-full flex flex-col justify-between px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link href={"/admin/categories"} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <Link href={"/admin/order"} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <Link href={"/admin/blog"} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <svg color="#606882" className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                    <path color="#606882" d="M 4 0 L 4 10 L 7 15 L 10 10 L 10 4 L 21 4 C 21.601563 4 22 4.398438 22 5 L 22 15 L 7 15 L 8.8125 17.40625 L 8.6875 17.5 L 6 19.6875 L 6 17 L 3 17 C 2.398438 17 2 16.601563 2 16 L 2 5 C 2 4.398438 2.398438 4 3 4 L 3 2 C 1.300781 2 0 3.300781 0 5 L 0 16 C 0 17.699219 1.300781 19 3 19 L 4 19 L 4 24 L 10 19 L 21 19 C 22.699219 19 24 17.699219 24 16 L 24 5 C 24 3.300781 22.699219 2 21 2 L 10 2 L 10 0 Z M 7 9 L 9 9.65625 L 9 9.6875 L 7.40625 12.3125 L 6.59375 12.3125 L 5 9.6875 L 5 9.65625 Z"></path>
                                </svg>
                    ...
                    <div>
                        <a href="#" className="flex items-center border-t-2 p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
